  ...
  private mockDealCompliance(dealId: string): any | null {
    const mockDeals: Record<string, any> = {
      'exec-001': {
        ...
        bucket_1: {
          bucket_num: 1,
          bucket_name: 'Shariah Governance & Compliance',
          component_name: 'Shariah Governance & Compliance',
          component_type: 'bucket_1',
        ...
        bucket_2: {
          bucket_num: 2,
          bucket_name: 'Regulatory & Legal Compliance',
          component_name: 'Regulatory & Legal Compliance',
          component_type: 'bucket_2',
        ...
        bucket_3: {
          bucket_num: 3,
          bucket_name: 'Risk Management',
          component_name: 'Risk Management',
          component_type: 'bucket_3',
          total_requirements: 18,
          completed_requirements: 15,
          evidence_count: 8,
          required_evidence_count: 10,
          control_completion: 83.3,
          evidence_completion: 80.0,
          overall_completion: 82.0,
          status: 'in_progress',
          needs_attention_count: 2,
          last_updated: new Date().toISOString(),
        },
        ...
        bucket_4: {
          bucket_num: 4,
          bucket_name: 'Financial & Product Reporting',
          component_name: 'Financial & Product Reporting',
          component_type: 'bucket_4',
        ...
        bucket_5: {
          bucket_num: 5,
          bucket_name: 'Audit & Assurance',
          component_name: 'Audit & Assurance',
          component_type: 'bucket_5',
      ...
      'deal-001': {
        deal_id: 'deal-001',
        deal_name: 'Green Sukuk Issuance - Renewable Energy Portfolio',
        // Bucket 1: Shariah Governance & Compliance
        bucket_1: {
          bucket_num: 1,
          bucket_name: 'Shariah Governance & Compliance',
          ...
          completed_requirements: 19,
          evidence_count: 12,
          required_evidence_count: 13,
          control_completion: 95.0,
          evidence_completion: 92.3,
        ...
        bucket_3: {
          ...
          evidence_count: 10,
          required_evidence_count: 12,
          control_completion: 86.4,
          evidence_completion: 83.3,
          overall_completion: 85.0,
          status: 'in_progress',
          needs_attention_count: 2,
          last_updated: new Date().toISOString(),
        ...
        bucket_4: {
          ...
          evidence_count: 22,
          required_evidence_count: 25,
          control_completion: 90.0,
          evidence_completion: 88.0,
      ...
      'deal-002': {
        ...
        bucket_1: {
          ...
          completed_requirements: 11,
          evidence_count: 6,
          required_evidence_count: 9,
          control_completion: 68.8,
          evidence_completion: 66.7,
          overall_completion: 68.0,
          status: 'in_progress',
          needs_attention_count: 4,
          last_updated: new Date().toISOString(),
        },
        ...
        bucket_2: {
          ...
          control_completion: 72.7,
          evidence_completion: 78.6,
        ...
        bucket_3: {
          ...
          evidence_count: 9,
          required_evidence_count: 12,
          control_completion: 75.0,
          evidence_completion: 75.0,
          overall_completion: 75.0,
          status: 'in_progress',
          needs_attention_count: 3,
          last_updated: new Date().toISOString(),
        ...
        bucket_4: {
          ...
          completed_requirements: 34,
          evidence_count: 18,
          required_evidence_count: 23,
          control_completion: 75.6,
          evidence_completion: 78.3,
        ...
        overall_completion: 74.0,
        status: 'in_progress',
        created_at: new Date().toISOString(),
      },
      'deal-003': {
        deal_id: 'deal-003',
        deal_name: 'Ijara Muntahia Bittamleek - Aircraft Leasing',
        // Bucket 1: Shariah Governance & Compliance
        bucket_1: {
          bucket_num: 1,
          bucket_name: 'Shariah Governance & Compliance',
          ...
          component_type: 'bucket_1',
          total_requirements: 18,
          completed_requirements: 17,
          evidence_count: 11,
          required_evidence_count: 12,
          control_completion: 94.4,
          evidence_completion: 91.7,
        ...
        bucket_3: {
          ...
          control_completion: 95.8,
          evidence_completion: 93.3,
          overall_completion: 95.0,
          status: 'in_progress',
          needs_attention_count: 1,
          last_updated: new Date().toISOString(),
        ...
        bucket_4: {
          ...
          component_type: 'bucket_4',
          total_requirements: 55,
          completed_requirements: 53,
          evidence_count: 28,
          required_evidence_count: 30,
          control_completion: 96.4,
          evidence_completion: 93.3,
          overall_completion: 96.0,
          status: 'in_progress',
          needs_attention_count: 1,
        ...
        bucket_5: {
          ...
          evidence_count: 10,
          required_evidence_count: 10,
          control_completion: 100.0,
          evidence_completion: 100.0,
      ...
      'deal-004': {
        deal_id: 'deal-004',
        deal_name: 'Diminishing Musharaka - Real Estate Development',
        // Bucket 1: Shariah Governance & Compliance
        bucket_1: {
          bucket_num: 1,
          bucket_name: 'Shariah Governance & Compliance',
          ...
          evidence_count: 2,
          required_evidence_count: 8,
          control_completion: 40.0,
          evidence_completion: 25.0,
          overall_completion: 40.0,
          status: 'in_progress',
          needs_attention_count: 5,
          last_updated: new Date().toISOString(),
        },
        ...
        bucket_2: {
          ...
          evidence_count: 2,
          required_evidence_count: 10,
          control_completion: 27.8,
          evidence_completion: 20.0,
        ...
        bucket_3: {
          ...
          evidence_count: 1,
          required_evidence_count: 12,
          control_completion: 22.7,
          evidence_completion: 8.3,
          overall_completion: 25.0,
          status: 'needs_attention',
          needs_attention_count: 10,
          last_updated: new Date().toISOString(),
        },
        // Bucket 4: Financial & Product Reporting
        bucket_4: {
          ...
          evidence_count: 8,
          required_evidence_count: 25,
          control_completion: 44.0,
          evidence_completion: 32.0,
        ...
        bucket_5: {
          ...
          evidence_count: 1,
          required_evidence_count: 8,
          control_completion: 33.3,
          evidence_completion: 12.5,
      ...
      'deal-005': {
        deal_id: 'deal-005',
        deal_name: 'Sukuk Al-Ijara - Infrastructure Portfolio',
        // Bucket 1: Shariah Governance & Compliance
        bucket_1: {
          bucket_num: 1,
          bucket_name: 'Shariah Governance & Compliance',
